...
import { productsURL } from "../../pages/home";
...
export const getPizzas = createAsyncThunk<PizzaItem[], RequestParams, {rejectValue: string}>(
  "pizza/getPizzas",
  async (
...
const pizzaSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getPizzas.fulfilled, (state, action: PayloadAction<PizzaItem[]>) => {
